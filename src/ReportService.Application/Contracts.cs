...
public record CreateReportRequest(Guid AnalysisProcessId, string SourceFileName, List<ReportComponentDto> Components, List<ReportRiskDto> Risks, List<ReportRecommendationDto> Recommendations, AiModelMetadataDto? AiModelInfo);
